...
public class BaseLineGenerator {
    ...
    public static void main(String[] args) {
        Set<File> dataSetsFolders = getLeafFolders(new File("E:/MyCode/Treemap/TreemapComparison/TreemapComparison/outputTest/Packing"));
        for (File dataSetFolder : dataSetsFolders) {
            ...
            try {
                ...
                File outputFolder = new File("E:/MyCode/Treemap/TreemapComparison/TreemapComparison/outputTest/baselineTest/Packing" + dataSetName);
                File rectangleInputFolder = dataSetFolder;

                File dataSet = new File("E:/MyCode/Treemap/TreemapComparison/TreemapComparison/Data/newDatasets/" + dataSetName);
...
//            System.out.println("generating baseline for time t=" + t);
            if(prevDm.getTargetSize()==0 && newDm.getTargetSize()==0) {
...
//            System.out.println("fileName = " + fileName);
    ...
    private TreeMap generateBaseLineFlat(TreeMap prevTm, DataMap prevDm, DataMap newDm) {
        ...
        if(newWeightsDm!=null) {
        	System.out.println(newWeightsDm.getLabel());

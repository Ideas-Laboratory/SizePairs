...
//        visVariables.add(AASSV);
        ...
        for (int i = 0; i < visVariables.size(); i++) {
            ...
            for (int j = 0; j < classStrings.size(); j++) {
                ...
                //Get the output Ipe string for the colored rectangle in the correct location for this class.
    ...
    /**
     * Returns a new list containing the names of the classes that have enough datasets.
     *
     * @param get
     * @return
     */
    ...
    /**
     * Returns a new list containing only the experiment results that belong to classString.
     *

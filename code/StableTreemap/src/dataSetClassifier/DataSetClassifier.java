...
public class DataSetClassifier {
    ...
    public static void main(String args[]) {
        ...
        List<DataFacilitator> datasets = Simulator.getDataFacilitatorFromFolder(new File("E:\\MyCode\\Treemap\\TreemapComparison\\TreemapComparison\\Data\\Datasets"));
    ...
    public List<Classification> classifyDataSets() {
        ...
        //write the output
        try ( BufferedWriter bw = new BufferedWriter(new FileWriter("E:\\MyCode\\Treemap\\TreemapComparison\\TreemapComparison\\Data\\DatasetClassifiedNew.csv"))) {
            //header row
            bw.append(sb);
            bw.flush();
        } catch (IOException e) {
